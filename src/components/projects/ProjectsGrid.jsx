		...
		dark:text-primary-light mb-4 mt-4"
						>
							<FormattedMessage
								id='project.info8'
								defaultMessage=
								'Design of a dashboard to provide detailed information on the latest soccer matches. Created with the Figma tool'
							/>
						</motion.p>
					</div>

					<div className='flex items-center justify-center mb-10'>
						<a href='https://www.behance.net/gallery/180390379/Al-Arco' target="_blank" rel="noopener noreferrer" class="font-general-medium flex justify-center items-center px-6 py-3 
  rounded-lg shadow-lg hover:shadow-xl bg-indigo-500 hover:bg-indigo-600 focus:ring-1 
  focus:ring-indigo-900 text-white text-lg sm:text-xl duration-300">
							<FormattedMessage
								id='project.button'
	...
	shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
		...
		dark:text-primary-light mb-4 mt-4"
					...
					<div className='flex items-center justify-center mb-10'>
						<a href='https://www.behance.net/gallery/180391275/Atenas-Gym-Club' target="_blank" rel="noopener noreferrer" class="font-general-medium flex justify-center items-center px-6 py-3 
  rounded-lg shadow-lg hover:shadow-xl bg-indigo-500 hover:bg-indigo-600 focus:ring-1 
  focus:ring-indigo-900 text-white text-lg sm:text-xl duration-300">
							<FormattedMessage
								id='project.button'
